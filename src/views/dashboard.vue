<template>
	<div>
		...
		<el-tabs type="border-card" @tab-change="changeTab">
						...
						<el-col :span="4">
							<el-card shadow="hover" :body-style="{ padding: '0px' }">
								<div class="grid-content grid-con-4">
									<el-icon class="grid-con-icon"><svg t="1676435839630" class="icon"
											viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
											p-id="11236" width="200" height="200">
											<path
												d="M533.2 928.4c-217.7 0-394.8-177.1-394.8-394.8l0.1-8c0.7-36.9 6.6-73.3 17.3-108.2 5.1-16.7 22.8-26 39.5-20.9 16.7 5.1 26 22.8 20.9 39.5-9 29.3-13.9 59.9-14.6 90.9l-0.1 6.8c0 182.9 148.8 331.7 331.7 331.7s331.7-148.8 331.7-331.7S716 201.9 533.2 201.9h-5.4c-26.5 0.4-52.9 4-78.4 10.6-16.9 4.4-34.1-5.7-38.5-22.6-4.4-16.9 5.7-34.1 22.6-38.5 30.4-7.9 61.8-12.2 93.4-12.7l6.4-0.1c217.7 0 394.8 177.1 394.8 394.8s-177.2 395-394.9 395z"
												p-id="11237" fill="#ffffff"></path>
											<path
												d="M533.2 767.7C404 767.7 299 662.7 299 533.6c0-2.9 0.1-5.7 0.1-8.5 0.8-23.3 5.1-46.3 12.7-68.2 5.7-16.5 23.7-25.2 40.2-19.5 16.5 5.7 25.2 23.7 19.5 40.2-5.5 16-8.6 32.7-9.3 49.7-0.1 2.1-0.1 4.2-0.1 6.3 0 94.3 76.7 171 171 171s171-76.7 171-171-76.7-171-171-171l-5 0.1c-12.6 0.4-25.1 2.1-37.3 5.2-16.9 4.3-34.1-5.9-38.4-22.8-4.3-16.9 5.9-34.1 22.8-38.4 16.6-4.2 33.8-6.6 51.1-7.1 2.3-0.1 4.5-0.1 6.8-0.1 129.1 0 234.2 105 234.2 234.2s-105 234-234.1 234z"
												p-id="11238" fill="#ffffff"></path>
											<path d="M533.2 533.6m-55.3 0a55.3 55.3 0 1 0 110.6 0 55.3 55.3 0 1 0-110.6 0Z"
												p-id="11239" fill="#ffffff"></path>
											<path
												d="M533.5 533.9c-12.3 12.3-32.4 12.3-44.7 0l-268-268c-12.3-12.3-12.3-32.4 0-44.7 12.3-12.3 32.4-12.3 44.7 0l268 268c12.3 12.3 12.3 32.4 0 44.7z"
												p-id="11240" fill="#ffffff"></path>
											<path
												d="M304.4 304.8l-84.9 15.6L98 198.9l85-15.5zM304.2 304.6l15.6-84.9L198.3 98.2l-15.5 85"
												p-id="11241" fill="#ffffff"></path>
										</svg></el-icon>
									<div class="grid-cont-right">
						...
						<el-col :span="4">
							<el-card shadow="hover" :body-style="{ padding: '0px' }">
								<div class="grid-content grid-con-6">
									<el-icon class="grid-con-icon"><svg t="1676435636209" class="icon"
											viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
											p-id="10529" width="200" height="200">
											<path d="M664.7 393l74.3-74.9 23.6 23.5-74.3 74.9-23.6-23.5z" p-id="10530"
												fill="#ffffff"></path>
											<path
												d="M783.1 363.8c-35.9 0-64.9-29.1-64.9-64.9s29.1-64.9 64.9-64.9 64.9 29.1 64.9 64.9-29.1 64.9-64.9 64.9z m0-96.6c-17.4 0-31.6 14.2-31.6 31.6 0 17.4 14.2 31.6 31.6 31.6 17.4 0 31.6-14.2 31.6-31.6 0.1-17.4-14.1-31.6-31.6-31.6zM228.2 712.5l105.4-105.1 23.5 23.6-105.4 105.1-23.5-23.6z"
												p-id="10531" fill="#ffffff"></path>
											<path
												d="M207.3 819.6h-1c-35.9-0.6-64.5-30.1-64-65.9 0.6-35.5 29.5-64 64.9-64h1c35.9 0.6 64.5 30.1 63.9 65.9-0.5 35.4-29.4 64-64.8 64zM159 753.9l16.7 0.2c-0.2 17.4 13.8 31.9 31.2 32.1 17.4 0.2 31.9-13.8 32.1-31.2 0.2-17.4-13.8-31.9-31.2-32.1-17.4-0.2-31.9 13.8-32.1 31.2-0.1 0-16.7-0.2-16.7-0.2zM636.4 646.3l23.5-23.5 95.8 95.8-23.5 23.5-95.8-95.8z"
												p-id="10532" fill="#ffffff"></path>
											<path
												d="M772.8 824.2c-16.4 0-32-6.1-44.1-17.3-12.8-11.8-20.1-27.9-20.8-45.2-0.7-17.3 5.4-33.9 17.2-46.6 24.3-26.3 65.5-27.9 91.8-3.6 26.3 24.3 27.9 65.5 3.6 91.8-11.8 12.8-27.9 20.1-45.2 20.8-0.8 0.1-1.7 0.1-2.5 0.1z m0.1-96.5c-8.5 0-17 3.4-23.2 10.1-11.9 12.8-11.1 32.9 1.7 44.7 6.2 5.8 14.2 8.8 22.8 8.4 8.4-0.3 16.3-3.9 22-10.1 5.8-6.2 8.8-14.3 8.4-22.8-0.3-8.4-3.9-16.2-10.1-22-6.3-5.6-13.9-8.3-21.6-8.3zM240.4 320l23.4-23.7 96.3 95.3-23.4 23.7-96.3-95.3z"
												p-id="10533" fill="#ffffff"></path>
											<path
												d="M223.1 344.3c-15.7 0-31.4-5.7-43.8-17.1-12.8-11.8-20.2-27.8-21-45.1s5.3-34 17-46.7c24.2-26.4 65.4-28.2 91.8-4 26.4 24.2 28.2 65.4 4 91.8-12.9 14-30.4 21.1-48 21.1z m0-96.6c-8.5 0-17.1 3.4-23.3 10.2-5.7 6.2-8.7 14.3-8.3 22.8 0.3 8.4 4 16.2 10.2 22 12.9 11.8 33 10.9 44.7-1.9 11.8-12.9 10.9-33-1.9-44.7-6-5.6-13.7-8.4-21.4-8.4zM703.9 506.2l68.7-0.6 0.3 33.3-68.7 0.6-0.3-33.3z"
												p-id="10534" fill="#ffffff"></path>
											<path
												d="M822 577.8c-0.9 0-1.7 0-2.6-0.1-15-0.7-28.9-7.1-39-18.2-20.9-22.9-19.3-58.5 3.6-79.4s58.5-19.3 79.4 3.6c20.9 22.9 19.3 58.5-3.6 79.4-10.4 9.5-23.7 14.7-37.8 14.7z m0-79c-5.6 0-11.1 2-15.4 6-9.3 8.5-10 23-1.4 32.3 4.1 4.6 9.8 7.1 15.9 7.4 6.1 0.2 12-1.9 16.4-6 9.3-8.5 10-23 1.4-32.3-4.6-5-10.8-7.4-16.9-7.4zM251.6 504.9l73.6-1.5 0.7 33.3-73.6 1.5-0.7-33.3z"
												p-id="10535" fill="#ffffff"></path>
											<path
												d="M215.7 573.9c-1.6 0-3.1-0.1-4.7-0.2-15-1.2-28.5-8.2-38.3-19.6-20.1-23.6-17.2-59.2 6.4-79.1 23.6-20.1 59.2-17.2 79.1 6.4 20.1 23.6 17.2 59.2-6.4 79.1-10.1 8.8-22.9 13.4-36.1 13.4z m-15-73.6c-9.7 8.2-10.8 22.6-2.7 32.2 4 4.7 9.4 7.5 15.5 8 6.1 0.6 12-1.4 16.7-5.3 9.7-8.2 10.8-22.6 2.7-32.2-8.1-9.7-22.5-10.9-32.2-2.7zM496.1 667.5l33.3-0.4 1.2 110.9-33.3 0.4-1.2-110.9z"
												p-id="10536" fill="#ffffff"></path>
											<path
												d="M514.3 867.9c-29.7 0-54.6-23.4-56.1-53.4-1.6-31 22.4-57.4 53.4-58.8 31-1.6 57.4 22.4 58.8 53.4 1.4 31-22.4 57.4-53.4 58.8h-2.7z m1.2-33.3l0.8 16.7-0.8-16.7c6.1-0.3 11.8-3 15.9-7.4 4.1-4.6 6.2-10.4 5.9-16.4-0.7-12.5-11.3-22.3-24-21.8-12.5 0.7-22.3 11.3-21.8 24 0.6 12.2 10.8 21.8 22.9 21.8 0.3-0.2 0.7-0.2 1.1-0.2zM497.2 298.1l33.3-0.5 1.7 110.9-33.2 0.5-1.8-110.9z"
												p-id="10537" fill="#ffffff"></path>
											<path
												...
												p-id="10538" fill="#ffffff"></path>
											<path
												d="M712.7 645.9H313.9V377.8h398.6v268.1h0.2z m-365.5-33.3h332V411.1h-332v201.5z"
												fill="#ffffff" p-id="10539"></path>
											<path d="M496.6 629.2h33.3v68.3h-33.3v-68.3z" fill="#ffffff" p-id="10540">
											</path>
											<path d="M371.7 690.8H656v33.3H371.7v-33.3z" fill="#ffffff" p-id="10541"></path>
										</svg></el-icon>
									<div class="grid-cont-right">
					...
					<el-row :gutter="10">
						<el-col :span="12">
							<el-card shadow="hover" :body-style="{ padding: '0px', height: '280px' }">
								<div class="card-body-title">
									...
									<span class="card-title-text">预警信息TOP10</span> 
									<p class="dashed-bottom"></p>
									<p class="end-png"></p>
								</div>
								<!-- <span class="warningTop">预警信息TOP10</span> -->
								<el-table ref="tableRef" :data="tableData" style="width: 95%;margin: auto;" stripe>
									...
									<el-table-column prop="tag" label="优先级" width="100">
										<template #default="scope">
											<el-tag :type="scope.row.tag === '中' ? '' : 'danger'">{{ scope.row.tag
											}}</el-tag>
										</template>
									</el-table-column>
								</el-table>
						...
						<el-col :span="12">
							<el-card shadow="hover" :body-style="{ padding: '0px', height: '280px' }">
								<div class="card-body-title">
									<span class="start-png"></span>
									<span class="card-title-text">运营商占比</span> 
									<p class="dashed-bottom"></p>
									<p class="end-png"></p>
								</div>
					...
					<el-row :gutter="10">
						<el-col :span="12">
							<el-card shadow="hover" :body-style="{ padding: '0px', height: '285px' }">
								<div class="card-body-title">
									<span class="start-png"></span>
									<span class="card-title-text">被攻击数据库ip排行</span> 
									<p class="dashed-bottom"></p>
									<p class="end-png"></p>
								</div>
						...
						<el-col :span="12">
							<el-card shadow="hover" :body-style="{ padding: '0px', height: '285px' }">
								...
								<div id="myChart2" :style="{ width: '92%', height: '277px' }"></div>
							</el-card>
						</el-col>
					</el-row>
				</div>
			...
			<el-tab-pane label="数据库安全事件汇总">
				<div class="container">
					<div class="handle-box">
						<span>时间：</span>
						<el-date-picker v-model="value1" type="datetimerange" range-separator="To"
							start-placeholder="Start date" end-placeholder="End date" style="width:38%" />&nbsp;&nbsp;
						<span>告警类型：</span>
						<el-select v-model="query.address" placeholder="告警类型" class="handle-select mr10" style="width:16%">
							<el-option key="1" label="数据库密码爆破" value="数据库密码爆破"></el-option>
							<el-option key="2" label="数据库勒索攻击" value="数据库勒索攻击"></el-option>
						</el-select>
						<span>事件id：</span>
						<el-input v-model="query.name" placeholder="事件id" class="eventid-input mr10"
							style="width:16%"></el-input><br /><br />
						<span>受害数据库IP：</span>
					...
					<el-table :data="curtableData2" class="tableStyle" ref="multipleTable"
						...
						<el-table-column prop="harmIP" label="受害者IP" min-width="115"
							show-overflow-tooltip></el-table-column>
						<el-table-column prop="attackIP" label="攻击者IP" min-width="115"
							show-overflow-tooltip></el-table-column>
						<el-table-column prop="warnType" label="告警类型" min-width="140"
							show-overflow-tooltip></el-table-column>
						<el-table-column prop="warnContent" label="事件名称" min-width="100"
							show-overflow-tooltip></el-table-column>
						<el-table-column prop="harmPort" label="目的端口" min-width="100"
							show-overflow-tooltip></el-table-column>
						<el-table-column prop="level" label="告警等级" min-width="100" align="center">
							<template #default="scope">
								<el-tag :type="scope.row.level === '低' ? '' : scope.row.level === '高' ? 'danger' : ''">
									{{ scope.row.level }}
								</el-tag>
							</template>
						</el-table-column>
				...
				<!-- 编辑弹出框 -->
				<el-dialog title="数据安全事件详情" v-model="editVisible" min-width="800px">
					<div class="dialog-body">
						...
						<div class="dialog-body-content">
							...
							<div><span class="dialog-body-left">时间：</span><span class="dialog-body-right">2023-05-29</span>
							</div>
							<div><span class="dialog-body-left">事件名称：</span><span class="dialog-body-right">密码爆破</span>
							</div>
							<div><span class="dialog-body-left">源IP：</span><span
									class="dialog-body-right">63.56.123.55</span></div>
							...
							<div><span class="dialog-body-left">目的IP：</span><span
									class="dialog-body-right">13.5.12.55</span></div>
						...
						<div class="dialog-body-content">
							<div><span class="dialog-body-left">告警类型：</span><span class="dialog-body-right">数据库密码爆破</span>
							</div>
							<div><span class="dialog-body-left">告警等级：</span><span class="dialog-body-right">高级</span></div>
							<div><span class="dialog-body-left">告警载荷：</span><span
									class="dialog-body-right">/x0qrvdngfe</span></div>
						</div>
						<br>
						<div class="dialog-body-title">
							<span class="start-png"></span>
						...
						<div style="margin-top: 6px;margin-left: 5px; font-size: 18px;font-weight: 600;">pool.use-138.com
						</div>
						<div class="dialog-body-content">
							...
							<div><span class="dialog-body-left">相关链接</span> <span class="dialog-body-right"
									style="cursor: pointer; color:rgb(0, 119, 255)">下载</span></div>
						</div>
						<br>
						<div class="dialog-body-title">
							<span class="start-png"></span>
				...
				<!-- <el-card shadow="hover" :body-style="{ padding: '0px',height:'285px'}"><div id="myChart" :style="{height: '277px',width:'50%'}"></div></el-card> -->
			</el-tab-pane>
		</el-tabs>
...
function initOption1() {
	...
	let option = {
		...
		series: [
			{
				type: 'bar',
				data: [242, 156, 128, 96, 85, 65, 50, 44, 32, 10]
			}
		]
	}
