		...
		<el-tabs type="border-card" @tab-change="changeTab">
            <el-tab-pane label="数据库安全事件统计">
				...
				<el-row :gutter="10">
					...
					<el-col :span="12">
						<el-card shadow="hover" :body-style="{ padding: '0px',height:'280px' }">
							<!-- <schart ref="bar" class="schart" canvasId="bar" :options="options" :style="{ width: '460px', height: '277px'}"></schart>							 -->
							<div id="myChart3" :style="{ width: '460px', height: '277px'}"></div>
						</el-card>
					</el-col>
				</el-row>
				<el-row :gutter="10">
					<el-col :span="12">
						<el-card shadow="hover" :body-style="{ padding: '0px',height:'285px'}">
							...
							<div id="myChart" :style="{ width: '460px', height: '277px'}"></div>
						</el-card>
					</el-col>
					<el-col :span="12">
						<el-card shadow="hover" :body-style="{ padding: '0px',height:'285px' }">
							<div id="myChart2" :style="{ width: '460px', height: '277px'}"></div>
						</el-card>
					</el-col>
				</el-row>
				</div>
