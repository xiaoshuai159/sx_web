        ...
        <el-card shadow="never" style="margin-top:10px; border-radius: 0" v-else>
            ...
            <el-row>
                ...
                <el-col :span="20">
                    ...
                    <div style="margin:15px 0"><span class="right-text">注册人:</span><span class="left-text">Redacted for Privacy</span>
