<template>
    <div>
        ...
        <div class="handle-box">
            ...
            <span>域名：</span>
            <el-input v-model="query.name" placeholder="域名" class="eventid-input mr10" style="width:16%"></el-input>
        ...
        <el-table :data="curtableData2" class="tableStyle" ref="multipleTable" header-cell-class-name="table-header" stripe>
            ...
            <el-table-column prop="danwei" label="单位信息" min-width="160" show-overflow-tooltip></el-table-column>
            <el-table-column prop="yuanIP" label="源IP地址" min-width="160" show-overflow-tooltip></el-table-column>
            <el-table-column prop="yuanPort" label="源端口" min-width="100" show-overflow-tooltip></el-table-column>
            <el-table-column prop="mudiIP" label="目的IP" min-width="160" show-overflow-tooltip></el-table-column>
            <el-table-column prop="mudiPort" label="目的端口" min-width="100" show-overflow-tooltip></el-table-column>
            <el-table-column prop="shujubao" label="日均数据包大小" min-width="160" show-overflow-tooltip></el-table-column>
            <el-table-column prop="pinlv" label="通信频率" min-width="100" show-overflow-tooltip></el-table-column>
            <el-table-column prop="xieyi" label="协议" min-width="80" show-overflow-tooltip></el-table-column>
            <el-table-column prop="chixu" label="持续连接时间" min-width="115" show-overflow-tooltip></el-table-column>
            <el-table-column prop="xingwei" label="行为判定" min-width="100" show-overflow-tooltip></el-table-column>
...
},
{
	id: 3,
	danwei: '天津市滨海新区司法局',
    yuanIP: '121.193.151.136',
    yuanPort: 26516,
    mudiIP: '10.240.252.221',
    mudiPort: 80,
    shujubao: '21MB',
    pinlv: '50次/秒',
    xieyi: 'https',
...
{
	id: 4,
	danwei: '天津市住房和城乡建设委员会',
    yuanIP: '1.192.137.122',
    yuanPort: 34528,
    mudiIP: '27.151.9.103',
    mudiPort: 80,
    shujubao: '3MB',
...
},
{
	id: 8,
	danwei: '南开大学滨海学院',
    yuanIP: '111.160.245.212',
    yuanPort: 53211,
    mudiIP: '111.160.245.212',
    mudiPort: 80,
    shujubao: '24MB',
    pinlv: '46次/秒',
    xieyi: 'https',
